  ...
  <div class="navbar navbar-dark shadow-sm" style="background:#b94c47">
    <div class="container">
      <a href="#" class="navbar-brand d-flex align-items-center">
        ...
        <strong>POSTULANTE | Debate 2023</strong>
      </a>
  ...
  <section class="text-center container">
    <div class="row py-lg-5"  style="background-image: url('../../assets/img/background.jpg');background-position: top;background-repeat: no-repeat;background-size: cover;width:100%;">
      <div class="col-lg-6 col-md-8 mx-auto rounded bg-light bg-opacity-75 p-2">
        ...
        <p class="lead text-dark mt-2">Sistema de postulación del INJUVENTUD para participar en el Concurso Juvenil de Debate 2023.</p>
        <p>
