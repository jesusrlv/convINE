  ...
  <div class="navbar navbar-dark shadow-sm" style="background: #FAD40D">
    <div class="container">
      <a href="#" class="navbar-brand d-flex align-items-center">
        ...
        <strong class="text-dark">ADMINISTRADOR | Debate Juvenil 2023</strong>
      </a>
    ...
    <nav class="navbar bg-body-tertiary">
      ...
      <div class="mb-4">
        <p><span id="seccion_MX"></span>
          <p class="h2">
          <i class="bi bi-flag-fill text-success"></i> Completados | 
              <a href="#inicio">
                <i class="bi bi-arrow-bar-up"></i>
              </a>
          </p>
        </p>
        <p><small>Postulantes<strong></strong>.</small></p>
      </div>
